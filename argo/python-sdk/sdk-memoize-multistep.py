        ...
        templates=[
            ...
            IoArgoprojWorkflowV1alpha1Template(
                ...
                container=Container(
                    ...
                    command=['sh', '-c'], 
                    args=["cowsay {0} | tee /mnt/vol/{1}.txt; ls /mnt/vol/".format(parameter1, parameter1)],
                ...
                outputs=IoArgoprojWorkflowV1alpha1Outputs(
                    artifacts=[ 
                        IoArgoprojWorkflowV1alpha1Artifact(
                            name="hello", 
                            path="/mnt/vol/{0}.txt".format(parameter1)
                        )
                    ]
                )
            ),
            ...
            IoArgoprojWorkflowV1alpha1Template(
                ...
                container=Container(
                    ...
                    args=["(cat /tmp/artifact1; cowsay {0}) > /mnt/vol/{1}.txt".format(parameter2, parameter2)],
                    volume_mounts=[VolumeMount(name="workdir",mount_path="/mnt/vol")]
                ),  
                outputs=IoArgoprojWorkflowV1alpha1Outputs(
                    artifacts=[ 
                        IoArgoprojWorkflowV1alpha1Artifact(
                            name="hello", 
                            path="/mnt/vol/{0}.txt".format(parameter2)
                        )
                    ]
                )
            ),
            ...
            IoArgoprojWorkflowV1alpha1Template(
                ...
                container=Container(
                    image='docker/whalesay:latest', 
                    command=['sh', '-c'], 
                    args=["(cat /tmp/artifact2; cowsay {0}) > /mnt/vol/{1}.txt".format(parameter3, parameter3)],
                    volume_mounts=[VolumeMount(name="workdir",mount_path="/mnt/vol")]
                ),  
                outputs=IoArgoprojWorkflowV1alpha1Outputs(
                    artifacts=[ 
                        IoArgoprojWorkflowV1alpha1Artifact(
                            name="hello", 
                            path="/mnt/vol/{0}.txt".format(parameter3)
                        )
                    ]
                )
            ),
